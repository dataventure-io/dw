...
public partial class CSVBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICSVVisitor<Result> {
	/// <summary>
	/// Visit a parse tree produced by <see cref="CSVParser.csvFile"/>.
	/// <para>
	...
	public virtual Result VisitCsvFile([NotNull] CSVParser.CsvFileContext context) { return VisitChildren(context); }
